...
namespace IS_Test
{
    public partial class GET_applicationplan : BaseForm
    {
        private const string sourceParam = "learnModeType";

        public GET_applicationplan()
        {
            InitializeComponent();

            cb_SourceType.Items.Clear();
            cb_SourceType.Items.Add("");
            Array sourceArray = Enum.GetValues(typeof(learnModeType));
